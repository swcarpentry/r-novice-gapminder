...
> * In the [prompt tab] enter: install.packages('ggplot2')<return>
> * (what else?)
>

We're going to start with a simple but powerful example of how R can help you analyse data. In RStudio's[the prompt panel], enter these commands (we'll explain how they work soon):
...
Much nicer! By using a logarithmic scale for GDP, the outliers no longer, er, lay out. Better yet, the relationship between the two factors we're graphing jumps out at us.