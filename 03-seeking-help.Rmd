...
> Use help to find out which function and with what parameters should you use
> to load data from csv file with columns delimited with "tab" and decimal point ".".
