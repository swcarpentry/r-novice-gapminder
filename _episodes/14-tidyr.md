...
~~~
tibble[,4] [5,112 × 4] (S3: tbl_df/tbl/data.frame)
...
~~~
tibble[,3] [5,112 × 3] (S3: tbl_df/tbl/data.frame)
...
~~~
tibble[,37] [142 × 37] (S3: tbl_df/tbl/data.frame)
...
~~~
tibble[,38] [142 × 38] (S3: tbl_df/tbl/data.frame)
