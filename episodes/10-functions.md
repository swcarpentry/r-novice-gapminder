...
[body]({{ site.github.url }}/reference/#function-body) of the function--the statements that are
...
use a [return statement]({{ site.github.url }}/reference/#return-statement) to send a result back
