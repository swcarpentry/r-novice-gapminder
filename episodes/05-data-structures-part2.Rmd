...
'black', 'calico' and 'tabby' in our case. The warning is telling us that we
unsuccessfully added 'tortoiseshell' to our original factor. Anything new that
doesn't fit into one of its categories is rejected as nonsense (becomes NA),
