...
- Use `str()`, `nrow()`, `ncol()`, `dim()`, `colnames()`, `rownames()`, `head()` and
...
- Be able to articulate what a `factor` is and how to convert between `factor` and
  `character`.
- Be able to find basic properties of a data frames including size, class or type
  of the columns, names, and first few rows.
