...
> >   tempK <- fahr_to_kelvin(tempF)
> >   celsius <- kelvin_to_celsius(tempK)
> >   return(celsius)
> > }
> > ```
> {: .solution}
...
fahr_to_kelvin(tempF = as.factor(32))
```

> ## Challenge 3
>
> Use defensive programming to ensure that our `fahr_to_celsius()` function
> throws an error immediately if the argument `tempF` is specified
> inappropriately.
>
>
