...
objectives:
- "Understand how to add and remove rows or columns."
- "Understand how to remove rows with `NA` values."
- "Understand how to append two data frames."
- "Understand what a `factor` is."
- "Understand how to convert a `factor` to a `character` vector and vice versa."
