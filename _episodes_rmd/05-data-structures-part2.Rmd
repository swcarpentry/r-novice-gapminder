...
Notice that `what different `cats` has no factors. This is because we read its data with the defensive (as in defensive driving) `read_csv()` fucntion instead of the ackward `read.csv()` function.
