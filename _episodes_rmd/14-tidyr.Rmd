...
teaching: 30
exercises: 15
questions: How can I change the layout of a data frame?
objectives: To understand the concepts of 'longer' and 'wider' data frame formats
  and be able to convert between them with `tidyr`.
keypoints:
...
> >
> > The original gapminder data.frame is in an intermediate format. It
> > is not purely long since it had multiple observation variables
> > (`pop`,`lifeExp`,`gdpPercap`). {: .solution} {: .challenge}
...
> Download the wide version of the gapminder data from
> [here](https://raw.githubusercontent.com/swcarpentry/r-novice-gapminder/gh-pages/_episodes_rmd/data/gapminder_wide.csv)
...
> ## Challenge 3
>
> Take this 1 step further and create a `gap_ludicrously_wide` format
