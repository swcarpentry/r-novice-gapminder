...
> >    tmp_ <- mean(subset(gapminder, continent==iContinent)$lifeExp)
...
> >
> > for( iContinent in unique(gapminder$continent) ){
> >    tmp_lifeExp <- mean(subset(gapminder, continent==iContinent)$lifeExp)
> >    
> >    if(tmp_lifeExp < thresholdValue){
...
> >     tmp_lifeExp <- mean(subset(gapminder, country==iCountry)$lifeExp)
> >     
> >     if(tmp_lifeExp < lowerThreshold){
> >         cat("Average Life Expectancy in", iCountry, "is less than", lowerThreshold, "\n")
> >     }
> >     else if(tmp_lifeExp > lowerThreshold && tmp_lifeExp < upperThreshold){
...
> >                 plot(year,lifeExp,
> >                      type="o",
> >                      main = paste("Life Expectancy in", iCountry, "over time", sep= " "),
