...
> >
> > In order to visulaize box plots we have to utilize the 'geom_boxplot' layer. It is important to notice that our x has to be a factor.
> > In our case continet is already a factor so no action is required.
> >
> > Advanced:
