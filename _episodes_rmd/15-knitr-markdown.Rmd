...
The key R package is `[knitr](http://yihui.name/knitr/)`. It allows
...
`knitr` allows you to mix basically any sort of text with code from different programming language, but we recommend that you use `R Markdown`, which mixes Markdown
...
The initial chunk of text (header) contains instructions for R to specify what kind of document will be created, and the options chosen. You can give the header a title, author, and date, and tell it that you're going to want
