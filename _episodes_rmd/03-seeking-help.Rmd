...
Notice how similar functions call for the same help file: 
...
This is because these functions have very similar applicability and often share the same arguments as inputs to the function.
...
> >
> > Its important to call the arguments explicitly by typing out the argument 
> > name e.g `sep = ","` so the function understands to use the "," as a 
>> seperator and not a term to concatenate.
> > e.g. 
> > ```{r} 
> > paste(c("a","b"), "c")
> > paste(c("a","b"), "c", ",")
