...
doesn't require an argument, whereas for the next set of mathematical functions we will need supply the function a value into order to compute the result.
