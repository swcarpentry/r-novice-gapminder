...
> > ```{r ch5-sol-alt1, eval=FALSE}
> > install.packages(c("ggplot2", "plyr", "gapminder"))
> >```
> > Another alternate solution, to first check if packages are installed, then install if necessary or load from library using pacman package
> > ```{r ch5-sol-alt2, eval=FALSE}
> > if (!require("pacman")) install packages("pacman")
> > pacman::p_load("ggplot2", "plyr", "gapminder")
> >```
