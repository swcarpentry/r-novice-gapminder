...
objectives:
- "Create and work with the five main types of data"
- "Create and modify vectors, lists, matrices and dataframes
- "Understand the roles of vectors, factors and lists in relation to data frames
- "Access information direclty in R about the type, class and structure of on object"
keypoints:
