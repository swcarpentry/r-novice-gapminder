...
R provides other functions for reading tablular data in different formats.
`read.delim` is useful for reading tab delimited data and `read.table` is a
more general function for dealing with all kinds of tabular data.
