...
Let's say you want to add details for another cat. You want to call this file
`data/feline-data_v2.csv` and have it look as follows.
...
tabby,2.3 or 2.4,1
```
We can make this data file similarly to how we did before:  
