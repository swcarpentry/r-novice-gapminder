...
> ## Tip: Renaming dataframe columns
>
> Dataframes have column names we can access them like we did with vectors
>
> ```{r}
> names(cats)
> ```
>
> If you want to rename the second column you can assign the new name to the second element of names
> ```{r}
