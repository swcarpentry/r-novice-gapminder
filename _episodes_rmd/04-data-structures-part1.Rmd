...
write.csv(x = cats_bad, file = "data/feline-data_challenge.csv", row.names = FALSE)
```
...
> factors later, and what to use them for. For now, remenber that in most cases,
...
> ```
> # Read data
> cats <- read.csv("data/feline-data-challenge.csv")
>
> # 1. Print the data
> _____
>
...
> > * The fourth row has the value "2.6 or 2.7". That is not a number
...
> > type is "double". Combining two data types yields the data type that
...
> {: .solution}
> 
> TODO: Where to save the challenge data  
> TODO: Can the text be be shortened?
>
{: .challenge}
...
We have data frames at the very beginning of this lession, they represent
