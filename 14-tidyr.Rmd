...
gap_wide2 <- read.csv("data/gapminder_wide.csv", header=TRUE, stringsAsFactors = FALSE)
identical(str(gap_wide),str(gap_wide2))
all.equal(gap_wide,gap_wide2)
identical(gap_wide,gap_wide2)
```
