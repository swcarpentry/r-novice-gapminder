...
Under the hood, a data.frame is a list of variables, which can be of different kind. In our `cats` example, we have an integer, a double and a logical variable. As we have seen already, each column of data.frame is a vector.
