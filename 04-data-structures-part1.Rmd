...
>```
> Try to get character vector of sex values from `sex` vector (currently of type
> factor) and numeric vector from `age`.
> Does using function `as.character()` or the function `as.numeric()` return
results you expect?
