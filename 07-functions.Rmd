...
> ```
>
> *Note:* the `paste` function has an argument called `collapse`, which is equivalent 
> to use sep = "" (add strings without a separator). The default is a space: " ". The default for `paste0`
> is no space "".
>
